/**
 * \file GUI/tga.cpp
 * \brief Code file, Several routines to handle tga image files
 *
...
void tgaLoadImageData(FILE *file, tgaInfo *info) {
  ...
  glTexImage2D(GL_TEXTURE_2D, 0, type, info->width, info->height, 0, type, GL_UNSIGNED_BYTE, info->imageData);
}	
