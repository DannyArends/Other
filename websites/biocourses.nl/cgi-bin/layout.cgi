...
sub printLayout{
  ...
  print("\t\t\t<br/>"."\n");
	...
	print("\t\t\t\t<img src='images/bio_top1.png' width='1024px' height='200px' alt='topimage biosources' />"."\n");
	print("\t\t\t\t<img src='images/bio_top2.png' width='1024px' height='200px' alt='topimage biosources' />"."\n");
	print("\t\t\t\t<img src='images/bio_top3.png' width='1024px' height='200px' alt='topimage biosources' />"."\n");
  print("\t\t\t\t<img src='images/bio_top4.png' width='1024px' height='200px' alt='topimage biosources' />"."\n");
  print("\t\t\t\t<img src='images/bio_top5.png' width='1024px' height='200px' alt='topimage biosources' />"."\n");
	print("\t\t\t</div>"."\n");
